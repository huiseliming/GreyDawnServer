...
const std::string Student::Cols::_age = "age";
...
const int32_t &Student::getValueOfAge() const noexcept
{
    const static int32_t defaultValue = int32_t();
    if(age_)
        return *age_;
...
const std::shared_ptr<int32_t> &Student::getAge() const noexcept
{
    return age_;
}
void Student::setAge(const int32_t &pAge) noexcept
{
...
void Student::setAgeToNull() noexcept
{
    age_.reset();
    dirtyFlag_[2] = true;
}
