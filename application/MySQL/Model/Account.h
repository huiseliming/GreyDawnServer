...
class Account
{
  public:
    ...
    const int32_t &getValueOfBalance() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getBalance() const noexcept;
    ///Set the value of the column balance
    void setBalance(const int32_t &pBalance) noexcept;
  ...
  private:
    ...
    std::shared_ptr<int32_t> balance_;
    struct MetaData
    {
